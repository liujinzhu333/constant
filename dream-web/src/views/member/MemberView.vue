    ...
    <section class="member-list">
      ...
      >
        ...
        <div class="card-info">
          ...
          <div class="card-meta">
            <el-tag size="small" type="info" effect="plain">{{ RELATION_LABELS[m.relation as MemberRelation] }}</el-tag>
      ...
      <div class="detail-header">
        ...
        <div class="detail-title">
          ...
          <div class="detail-meta">
            <el-tag type="info">{{ RELATION_LABELS[currentMember.relation as MemberRelation] }}</el-tag>
        ...
        <el-form-item label="选择人员">
          <el-select v-model="relationTargetId" filterable placeholder="搜索姓名" style="width:100%">
            <el-option
              ...
              :key="m.id"
              :label="`${m.name}${m.nickname ? '「' + m.nickname + '」' : ''}（${RELATION_LABELS[m.relation as MemberRelation]}）`"
              :value="m.id"
            />
          </el-select>
        </el-form-item>
...
function openEditDialog() {
  ...
  form.value = {
    ...
    relation:       m.relation as MemberRelation,
    relation_title: m.relation_title,
    phone:          m.phone,
    email:          m.email,
    note:           m.note,
...
// 切换选中人员时同步 currentMember（离线写操作后 store 更新）
...
@media (max-width: 768px) {
  ...
  .member-list.has-detail { display: none; }
}
</style>
